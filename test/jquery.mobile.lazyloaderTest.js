QUnit.module( "jquery.mobile.lazyloader Test", {
  ...
  (
    function() {
      var provider = {
        "scrollstart with no previous event and ignoreEvent set to false": {
          event: "scrollstart",
        ...
        "scrollstop with no previous event and ignoreEvent set to false": {
          event: "scrollstop",
          eventTriggered: false,
          expectedLoadCallCount: 2,
          ignoreEvent: false,
        ...
        "wheel with no previous event and ignoreEvent set to false": {
          event: "wheel",
          eventTriggered: false,
          expectedLoadCallCount: 2,
          ignoreEvent: false,
        ...
        "scrollstart with no previous event and ignoreEvent set to true": {
          event: "scrollstart",
          eventTriggered: false,
        ...
        "scrollstop with no previous event and ignoreEvent set to true": {
          event: "scrollstop",
          eventTriggered: false,
          expectedLoadCallCount: 1,
          ignoreEvent: true,
        ...
        "wheel with no previous event and ignoreEvent set to true": {
          event: "wheel",
          eventTriggered: false,
          expectedLoadCallCount: 1,
          ignoreEvent: true,
        ...
        "scrollstart with a previous event and ignoreEvent set to false": {
          event: "scrollstart",
          eventTriggered: true,
          expectedLoadCallCount: 1,
          ignoreEvent: false,
        ...
        "scrollstop with a previous event and ignoreEvent set to false": {
          event: "scrollstop",
          eventTriggered: true,
          expectedLoadCallCount: 1,
          ignoreEvent: false,
        ...
        "wheel with a previous event and ignoreEvent set to false": {
          event: "wheel",
          eventTriggered: true,
          expectedLoadCallCount: 1,
          ignoreEvent: false,
      ...
      function testConstructor( test, testData ) {
        QUnit.test(
          ...
          function( assert ) {
            ...
            ignoreEvent = testData.ignoreEvent;
            ...
            assert.equal( data._eventTriggered, testData.expectedEventTriggered );
